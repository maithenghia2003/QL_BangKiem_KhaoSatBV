...
{
    public class TiemDuoiDaController : Controller
    {
            ...
            var cacBuocTienHanh = new List<BuocTienHanh>
        {
            ...
            new BuocTienHanh { STT = 8, MoTa = "Véo da chỗ tiêm, mặt vát kim hướng lên trên" },
            new BuocTienHanh { STT = 9, MoTa = "Đưa kim góc 30 - 45 so với mặt da" },
